...
export const metadata: Metadata = {
  title: "Thank You | Military Family Institute",
  description: "Thank you for contacting Military Family Institute.",
}
      ...
      <section className="py-28 sm:py-36">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-[#1F2933]/80 leading-relaxed mb-10">
            Your message has been received. A member from our team will reach out
            to you shortly.
          </p>
          <Button
            asChild
